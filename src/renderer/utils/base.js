export const stupath = 'http://192.168.10.139:8899/';
export const stuwspath='ws://192.168.10.139:8899/';
export const teacherpath = 'http://192.168.10.139:8080/';
export const teacherwspath='ws://192.168.10.139:8080/';
...
export const allchinese = new RegExp(
		"^[\u3002\uff1b\uff0c\uff1a\u201c\u201d\uff08\uff09\u3001\uff1f\u300a\u300b\u4e00-\u9fa5]|\s+$");
export default {
	stupath,
	stuwspath,
