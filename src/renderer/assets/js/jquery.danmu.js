                ...
                setTimeout(function () {
                    ...
                    if ($(element).data("danmuList")[$(element).data("nowTime")] && me.launched.indexOf($(element).data("nowTime")) < 0) {
                        ...
                        for (var i = (danmus.length - 1); i >= 0; i--) {
                            ...
                            var a_danmu = "<span class='danmaku' id='" + me.id + "tempDanmaku'><span class='avatar'><image src='static/img/avatar.png'/></span><span class='name'></span></span>";
                            $(element).append(a_danmu);
                            var danmaku = danmus[i];
                            var str=''
                            $("#" + me.id + "tempDanmaku .name").text(danmaku.text)
                                .css({
                                    "color": danmaku.color
